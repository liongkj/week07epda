...
import static controller.Home.JDBC_DRIVER;
...
Statement stmt = null;
            ...
            try {
                ...
                String sql = "UPDATE usertable SET PASSWORD = "+ password + "WHERE name = '" + name + "'";
                stmt.executeUpdate(sql);  //store search result into rs
